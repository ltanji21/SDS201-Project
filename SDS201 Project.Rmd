...
favstats(~Age.upon.Outcome, data = Austin_Animals)
...
Austin_Animals2 <- Austin_Animals %>%
  ...
  select(DateTime, MonthYear, Date.of.Birth, Homed, Outcome.Subtype, Animal.Type, Sex.upon.Outcome, Age.upon.Outcome, Breed, Outcome.Type)
```
